...
namespace coreDemo.Models
{
    public class TestModel
    {
        ...
        public IEnumerable<Microsoft.AspNetCore.Mvc.Rendering.SelectListItem> Select1 { get; set; }
        ...
        public IEnumerable<Microsoft.AspNetCore.Mvc.Rendering.SelectListItem> Select2 { get; set; }
        [DisplayName("複選-2")]
        ...
        [StringLength(5, MinimumLength = 2, ErrorMessage = "長度2-5")]
        [RegularExpression("^[0-9]+$", ErrorMessage = "非數字不行")]
        ...
        public IEnumerable<Microsoft.AspNetCore.Mvc.Rendering.SelectListItem> ClassSelect { get; set; }

        [DisplayName("學生")]
        [Required(ErrorMessage = "您必須輸入學生！")]
        public string StudentId { get; set; }
        public IEnumerable<Microsoft.AspNetCore.Mvc.Rendering.SelectListItem> StudentSelect { get; set; }
    }
}